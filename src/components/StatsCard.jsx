...
export function StatsCard() {
  return (
    ...
    >
      <p className="text-[10px] font-mono uppercase tracking-[0.1em] mb-3" style={{ color: "var(--t3)" }}>
        Resumen del homelab
      </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 flex-1">
        {STATS.map((stat, i) => {
          ...
          return (
            ...
            >
              <Icon size={14} style={{ color: "var(--a)" }} aria-hidden="true" />
              <div
              ...
              <div className="text-[10px] leading-tight" style={{ color: "var(--t3)" }}>
                {stat.label}
              </div>
            </motion.div>
          );
